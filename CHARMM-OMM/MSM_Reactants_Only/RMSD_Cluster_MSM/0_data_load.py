...
if not os.path.exists('topology.pdb'):
    os.symlink('/Users/robert_arbon/Code/AADH/Analysis/MSM_Reactants_Only/2agy_rxt.pdb', 'topology.pdb')
if not os.path.exists('topology.psf'):
    os.symlink('/Users/robert_arbon/Code/AADH/Analysis/MSM_Reactants_Only/2agy_rxt.psf', 'topology.psf')
